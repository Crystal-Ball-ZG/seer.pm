...
<section class="mx-auto">
	<div class="flex flex-col p-1 md:p-2">
		...
		>
			...
			<button class="font-grotesk bg-#6236FF/80 hover:bg-#6236FF px-6 md:px-10 py-3 md:py-4 md:my-5 rounded-3xl absolute bottom-8 md:bottom-12 z-2">
		...
		{#each pages as page}
			<div class="border-1 border-#6236FF w-full h-118 rounded-3xl mb-8 p-10 md:p-12 relative">
				...
				<button class="font-grotesk bg-#6236FF/80 hover:bg-#6236FF px-4 py-2 md:px-6 md:py-3 absolute bottom-8 md:bottom-12 rounded-3xl text-3xl z-2">
					<a href={page.href}>></a>
				</button>
			</div>
		{/each}
