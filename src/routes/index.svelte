...
<section class="mx-auto">
	<div class="flex flex-col">
		<div
			class="bg-gradient-to-bl to-#0100FE/90 from-#C000B0/95 w-full h-100 mb-8 md:h-118 rounded-3xl p-8 md:p-12 relative"
		>
			...
			<div class="absolute z-2 w-60/100">
				<h2 class="font-grotesk font-bold text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl mb-4">{hero.name}</h2>
			</div>
		...
		{#each pages as page}
			<div class="border-1 border-#6236FF w-full h-100 md:h-118 rounded-3xl mb-8 p-10 md:p-12 relative">
				...
				<div class="absolute z-2 w-60/100">
					<h2 class="font-grotesk font-bold text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl mb-4">{page.name}</h2>
				</div>
