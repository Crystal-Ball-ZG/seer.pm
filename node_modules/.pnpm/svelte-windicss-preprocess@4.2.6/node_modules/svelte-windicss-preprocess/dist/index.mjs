...
function fileURLToPath(id2) {
  ...
  return normalizeSlash(_fileURLToPath(id2));
}
...
var init_resolve = __esm({
  "node_modules/mlly/lib/resolve.mjs"() {
    ...
    DEFAULT_URL = pathToFileURL(process.cwd());
...
import { StyleSheet as StyleSheet2 } from "windicss/utils/style";
...
function main() {
  ...
  return {
    async style({ content, attributes, filename }) {
      ...
      if (!filename)
        return { code: content };
      let preflightStyleSheet = new StyleSheet2();
      ...
      let safelistStyleSheet = new StyleSheet2();
      let safelistIconsStyleSheet = new StyleSheet2();
      ...
      const cssStyleSheet = new CSSParser(content, generatorWindi).parse() || new StyleSheet2();
      let cssStyles = "";
